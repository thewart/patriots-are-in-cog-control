...
parameters {
  ...
  matrix[K, 2] beta_mu;
  vector<lower=0>[K] beta_row_sigma;
...
generated quantities {
  ...
  {
    matrix[N_rep, K] X_rep = design_matrix(col(X, 1), col(X, 2), col(X, 3), col(X, 4), K);
